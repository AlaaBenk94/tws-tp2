...
let SIZE = null;
let STEP = null;
var ___centroid, ___delta, ___distance, ___length, ___radians, ___rotate, ___scale, ___translate, __distanceAtAngle,
    __resample, __rotateToZero, __scaleToSquare, __translateToOrigin, _binds, _candidates, _findBestMatch, _hasBinds,
    _options, _templates, _transform;
